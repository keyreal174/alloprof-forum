                    ...
                    <td class="content-cell">
                        ...
                        if ($row['RecordName']) {
                            ...
                            $authorBlock->setView('media-sm')
                                ...
                                ->addMeta('<a href="'.url($row['RecordType']=='Discussion'?DiscussionModel::discussionUrl($row['Data'], "", "/"):CommentModel::commentUrl($row['Data'])).'"><b>'.htmlspecialchars(t($recordLabel, $recordLabel))." - ".strtoupper($row['Data']["Language"]).'</b></a>')
