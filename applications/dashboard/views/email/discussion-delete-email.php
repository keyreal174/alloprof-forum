...
<body bgcolor="{$email.backgroundColor}"
    ...
    <center class="wrapper"
        ...
        <div class="webkit" style="margin: 0 auto;padding: 0;box-sizing: border-box;font-size: 100%;max-width: 600px">
            ...
            <p class="black--text" style="margin-top: 32px; margin-bottom: 64px;">Retourne sur la <a href="https://www.alloprof.qc.ca/zonedentraide" class="green--text">Zone d’entraide</a> et propose-nous une nouvelle version! <br><br>
            À tout de suite!</p>
