...
<div class="BoxFilter BoxProfileInfo">
    <?php
        if(userRoleCheck() != Gdn::config('Vanilla.ExtraRoles.Teacher')) {
            ...
            echo '<div class="BoxProfileInfo_detailbox__item"><a href="'.$Controller->data('Counts')["Like"]["Url"].'">'.$Controller->data('Counts')["Like"]["Total"].'</a><svg width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
