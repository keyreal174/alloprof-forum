...
%text</a>'); ?>
        ...
        <div class='Navigation-linkContainer'>
            <?php
                $wheres = ['UserID' => Gdn::session()->UserID, 'bookmarked' => 1];
                $count = Gdn::sql()->getCount('UserDiscussion', $wheres);
                $text = t('Question followed');
                if ($count) {
                    $text = t('Question followed').' <span class="Count">'.htmlspecialchars($count).'</span>';
                }
                echo Gdn_Theme::link('discussions/bookmarked', sprite('Home').' '.$text, '<a href="%url" class="%class Navigation-link HasCount"><svg width="19" height="21" viewBox="0 0 19 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
%text</a>'); ?>
        ...
        <div class='Navigation-linkContainer'>
            <?php echo Gdn_Theme::link('discussions/mine', sprite('Home').' '.t('My Questions'), '<a href="%url" class="%class Navigation-link"><svg width="21" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
