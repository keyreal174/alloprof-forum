<div class="BoxCheckAnswer">
    ...
    <div class="BoxCheckAnswer-answers">
        <a>
            <img src="/themes/alloprof/design/images/good.svg" width="44px" height="44px" />
            <span> <?php echo t("It's perfect!") ?> </span>
        </a>
        <a href="/discussion/bad" class="OptionsLink Popup">
            <img src="/themes/alloprof/design/images/bad.svg" width="44px" height="44px" />
