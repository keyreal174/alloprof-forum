    ...
    <?php
        // if($Session->isValid()) {
            ...
            if($Session->isValid()) {
                ...
                echo '<a tabIndex="1" class="btn-default btn-shadow AskQuestionPopupValid">'.t("Ask a question").'</a>';
            } else {
                echo '<a href="'.url('/post/newDiscussion/'. $categoryID) .'" class="btn-default btn-shadow SignInStudentPopupAgent scrollToAskQuestionForm scrollToAskQuestionFormPopup HiddenImportant">'.t("Ask a question").'</a>';
                echo '<a tabIndex="1" class="btn-default btn-shadow AskQuestionPopupInValid">'.t("Ask a question").'</a>';
            }
    ?>
</div>
<?php } ?>